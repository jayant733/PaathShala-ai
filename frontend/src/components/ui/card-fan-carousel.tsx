...
export interface CardItem {
  /** Background image. Ignored when `visual` is provided. */
  imgUrl?: string;
  alt?: string;
  linkUrl?: string;
  /** Optional content rendered as an overlay over the image. */
  content?: ReactNode;
  /** Optional fully-custom visual (e.g. a phone mockup) replacing the image + overlay. */
  visual?: ReactNode;
}
